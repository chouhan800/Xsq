...
photologo = 'https://tinypic.host/images/2025/08/30/IMG_20250727_093946_936.th.jpg' #https://envs.sh/GV0.jpg
        ...
        if message.from_user:
            ...
            if not status["is_subscribed"]:
                await message.reply_text(
                    ...
                    "╭─────────────────\n"
                    "┣⪼ **📌 𝐏𝐥𝐞𝐚𝐬𝐞 𝐜𝐨𝐧𝐭𝐚𝐜𝐭**\n"
                    "┣⪼ **👤 tg://openmessage?user_id=8050673236**\n"
                    "┣⪼ **💫 𝐅𝐨𝐫 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧**\n"
                    "╰─────────────────"
                )
                return False
